...
Classifiers Used: Classifier Description SVM Support Vector Machine MultinomialNB Naive Bayes (suitable for text) GaussianNB Naive Bayes with Gaussian model LogisticRegression Logistic regression RandomForest Ensemble of decision trees AdaBoost Boosting ensemble method 📈 Evaluation Metrics:
...
🧾 Results:- Classifier Accuracy (%) Precision Recall F1 Score SVM 98.91 0.996 0.923 0.958 MultinomialNB 98.04 0.892 0.972 0.930 GaussianNB 90.54 0.593 0.931 0.725 Logistic 98.10 0.961 0.894 0.926 RandomForest 97.77 1.000 0.833 0.909 AdaBoost 92.01 0.867 0.476 0.614

✅ Best performing model: SVM with ~99% accuracy.

🔲 Confusion Matrix for SVM Predicted Ham Predicted Spam Actual Ham 1592 1 Actual Spam 19 227 📊 Visualization Tools
